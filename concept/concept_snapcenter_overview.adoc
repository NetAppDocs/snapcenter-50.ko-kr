...
+
Windows cmdlet에 대한 자세한 내용은 을 https://docs.netapp.com/us-en/snapcenter-cmdlets-50/index.htmllllll["SnapCenter 소프트웨어 cmdlet 참조 가이드"^]참조하십시오.
...
* SnapCenter 맞춤형 플러그인
+
사용자 지정 플러그인은 커뮤니티에서 지원되며 에서 다운로드할 수 https://automationstore.netapp.com/home.shtml["NetApp 스토리지 자동화 스토어"^]있습니다.
