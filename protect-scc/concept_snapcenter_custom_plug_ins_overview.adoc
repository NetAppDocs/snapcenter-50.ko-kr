...
NetApp은 또한 MySQL, MAXDB, DB2, Sybase, DPGLUE, MongoDB, ORASCPM 및 PostgreSQL 맞춤형 플러그인 이러한 플러그인은 에서 다운로드할 https://automationstore.netapp.com/home.shtml["NetApp 스토리지 자동화 스토어"^]수 있습니다.
...
을 참조하여 사용자 지정 플러그인을 만들 수 link:concept_develop_a_plug_in_for_your_application.html["응용 프로그램용 플러그인을 개발합니다"^]있습니다.
