...
+
MySQL 또는 DB2 애플리케이션을 관리하려는 경우 NetApp에서 제공하는 MySQL 및 DB2 사용자 지정 플러그인을 사용할 수 있습니다. MySQL 및 DB2 사용자 지정 플러그인은 에서 사용할 수 있습니다 https://automationstore.netapp.com/home.shtml["NetApp 자동화 스토어"]
