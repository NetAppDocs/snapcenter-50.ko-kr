...
+
.. 백업 작업만 나열되도록 목록을 필터링하려면 image:../media/filter_icon.png[""] 클릭합니다.
.. 시작 및 종료 날짜를 지정합니다.
...
NOTE: 백업 작업 상태가 표시되지만image:../media/success_icon.gif["완료 아이콘"]작업 세부 정보를 클릭하면 백업 작업의 일부 하위 작업이 아직 진행 중이거나 경고 기호로 표시된 것을 볼 수 있습니다.
...
. image:../media/activity_pane_icon.gif[""]Activity(활동) 패널을 클릭하여 가장 최근의 5개 작업을 봅니다.
+
